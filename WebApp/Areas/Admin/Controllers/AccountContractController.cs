    ...
    public class AccountContractController : Controller
    {
        ...
        public async Task<IActionResult> GetListPending([FromBody]  GetListCompanyPaging req)
        {
            try
            {
                ...
                _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
                HttpResponseMessage response = await _client.PostAsync(_client.BaseAddress + "/AccountContract/GetListPending", httpContent);
        ...
        public async Task<IActionResult> SignPdfWithAdminCertificate([FromBody] SignAdminRequest request)
        {
            try
            {
                ...
                HttpResponseMessage response = await _client.PostAsync(_client.BaseAddress + "/AccountContract/SignPdfWithAdminCertificate", httpContent);
        ...
        public async Task<IActionResult> Insert([FromBody] SignAdminRequest request)
        {
            ...
            try
            {
                ...
                _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
                var response = await _client.PostAsync(_client.BaseAddress + "/AccountContract/Insert", jsonContent);
