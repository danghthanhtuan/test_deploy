...
CREATE TABLE COMPANY (
	...
	TEMPS INT ,		--0 BẢN ĐẦU TIÊN, >0 STT NHỮNG HỢP ĐỒNG TIẾP THEO
	TEMPS_STATUS BIT ----0 Bản nháp, 1 bản duyệt
...
DELETE FROM PAYMENT_TRANSACTION WHERE PAYMENT_ID = 4
DELETE FROM PAYMENT_TRANSACTION WHERE PAYMENT_ID = 5
