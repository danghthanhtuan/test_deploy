...
CREATE TABLE CONTRACTS (
    ...
    FOREIGN KEY (CUSTOMERID) REFERENCES COMPANY(CUSTOMERID),
	CONSTATUS NVARCHAR(50) DEFAULT N'Đang xử lý'
);

CREATE TABLE CONTRACT_FILES (
    ID INT IDENTITY(1,1) PRIMARY KEY,
    CONTRACTNUMBER INT NOT NULL,               -- Khóa ngoại đến bảng CONTRACTS
    CONFILE_NAME NVARCHAR(255) NOT NULL,       -- Tên file (ví dụ: HopDong_ABC123.pdf)
    FILE_PATH NVARCHAR(500) NOT NULL,          -- Đường dẫn vật lý hoặc URL
    UPLOADED_AT DATETIME DEFAULT GETDATE(),    -- Thời gian upload
    IS_SIGNED BIT DEFAULT 1,                   -- Đã ký hay chưa (mặc định là đã ký)
    
    CONSTRAINT FK_CONTRACT_FILES_CONTRACTS FOREIGN KEY (CONTRACTNUMBER)
...
CREATE TABLE STAFF (
	...
	STAFFEMAIL VARCHAR(40) NOT NULL UNIQUE, -- EMAIL
...
values('Sta1', N'Nguyễn Thị Kim Liên', N'Quận 9', '2000-08-25', 'liennbtbt11@gmail.com',1,'0365812847',N'Admin')

INSERT INTO LOGINADMIN(STAFFID, USERNAMEAD, PASSWORDAD) VALUES ('Sta1', '0365812847','$2a$11$WhusSTM44fBBxah.J17CIObhHKylM7PfbFW7jddYDWJ.RjFQlzT1G');
